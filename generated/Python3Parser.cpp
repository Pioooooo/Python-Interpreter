...
std::vector<Python3Parser::Muldiv_opContext *> Python3Parser::TermContext::muldiv_op() {
  return getRuleContexts<Python3Parser::Muldiv_opContext>();
}

Python3Parser::Muldiv_opContext* Python3Parser::TermContext::muldiv_op(size_t i) {
  return getRuleContext<Python3Parser::Muldiv_opContext>(i);
}
...
Python3Parser::Muldiv_opContext::Muldiv_opContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* Python3Parser::Muldiv_opContext::STAR() {
  return getToken(Python3Parser::STAR, 0);
}

tree::TerminalNode* Python3Parser::Muldiv_opContext::DIV() {
  return getToken(Python3Parser::DIV, 0);
}

tree::TerminalNode* Python3Parser::Muldiv_opContext::IDIV() {
  return getToken(Python3Parser::IDIV, 0);
}

tree::TerminalNode* Python3Parser::Muldiv_opContext::MOD() {
  return getToken(Python3Parser::MOD, 0);
}


size_t Python3Parser::Muldiv_opContext::getRuleIndex() const {
  return Python3Parser::RuleMuldiv_op;
}

void Python3Parser::Muldiv_opContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<Python3Listener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterMuldiv_op(this);
}

void Python3Parser::Muldiv_opContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<Python3Listener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitMuldiv_op(this);
}


antlrcpp::Any Python3Parser::Muldiv_opContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<Python3Visitor*>(visitor))
    return parserVisitor->visitMuldiv_op(this);
  else
    return visitor->visitChildren(this);
}

Python3Parser::Muldiv_opContext* Python3Parser::muldiv_op() {
  Muldiv_opContext *_localctx = _tracker.createInstance<Muldiv_opContext>(_ctx, getState());
  enterRule(_localctx, 54, Python3Parser::RuleMuldiv_op);
  size_t _la = 0;
...
std::vector<std::string> Python3Parser::_ruleNames = {
  ...
  "arith_expr", "addsub_op", "term", "muldiv_op", "factor", "atom_expr", 
